class ServicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @service.save
        format.html { redirect_to admin_servicii_path, notice: "Serviciul a fost adaugat cu succes." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_servicii_path, notice: "Serviciul  a fost sters." }
