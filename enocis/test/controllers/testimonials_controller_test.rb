...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { approved: @testimonial.approved, comment: @testimonial.comment, name: @testimonial.name, title: @testimonial.title } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { approved: @testimonial.approved, comment: @testimonial.comment, name: @testimonial.name, title: @testimonial.title } }
