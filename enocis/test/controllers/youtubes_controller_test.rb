...
class YoutubesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create youtube" do
    assert_difference('Youtube.count') do
      post youtubes_url, params: { youtube: { service_id: @youtube.service_id, url: @youtube.url } }
    end
  ...
  test "should update youtube" do
    patch youtube_url(@youtube), params: { youtube: { service_id: @youtube.service_id, url: @youtube.url } }
